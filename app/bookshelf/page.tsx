    ...
    <div className="container py-8">
      <div className="space-y-6">
        {bookshelfData.map((book) => (
          <div key={book.title} className="neo-surface flex flex-col overflow-hidden sm:flex-row">
            <Link
              href={book.href}
            ...
            >
              <Image
                alt={book.title}
                src={book.cover}
                className="h-52 w-auto object-contain drop-shadow-md transition-transform duration-300 hover:scale-105"
                width={160}
                height={220}
              />
            </Link>
